...
describe ReqLLM::Schema do
  describe ".validate" do
    it "passes a conforming object" do
      ...
      ReqLLM::Schema.validate(data, schema).should be_nil
    end
    ...
    it "raises on a missing required key" do
      ...
      expect_raises(ReqLLM::Error::Validation, /name/) do
        ReqLLM::Schema.validate(data, schema)
      end
    end
    ...
    it "raises on a nested object property mismatch" do
      ...
      expect_raises(ReqLLM::Error::Validation, /user.*name|name/) do
        ReqLLM::Schema.validate(data, schema)
      end
    end
    ...
    it "raises on an array element type mismatch" do
      ...
      expect_raises(ReqLLM::Error::Validation) do
        ReqLLM::Schema.validate(data, schema)
      end
    end
    ...
    it "raises on an extra key when additionalProperties is false" do
      ...
      expect_raises(ReqLLM::Error::Validation, /extra/) do
        ReqLLM::Schema.validate(data, schema)
      end
    end
  ...
  describe ".enforce_strict" do
    it "marks all properties required and adds additionalProperties:false" do
      ...
      out = ReqLLM::Schema.enforce_strict(schema)
