...
# Unit O DoD: ReqLLM.generate_text working end-to-end, OpenAI, fixture-backed,
...
describe "ReqLLM.generate_text" do
  ...
  it "is fully offline — the fixture short-circuits transport (deterministic result)" do
    ...
    first = ReqLLM.generate_text("openai:gpt-4o-mini", "Hi", fixture: "chat_basic")
    second = ReqLLM.generate_text("openai:gpt-4o-mini", "Hi", fixture: "chat_basic")
