...
private def parse(input : String) : Array(ReqLLM::SSE::Event)
  ReqLLM::SSE.parse(IO::Memory.new(input))
end

describe ReqLLM::SSE do
  ...
  it "yields events incrementally via each_event" do
    collected = [] of String
    ReqLLM::SSE.each_event(IO::Memory.new("data: a\n\ndata: b\n\n")) do |event|
