module ReqLLM
  ...
  #
  # The metadata / reasoning_details fields exist for lossless round-tripping
  # of provider-specific data across conversation turns.
  struct Message
    getter role : Role
    ...
    def initialize(role : Role, text : String, *,
      ...
      initialize(role, [ContentPart.text(text)],
        ...
        metadata: metadata, reasoning_details: reasoning_details)
    end
