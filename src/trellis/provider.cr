...
module Trellis
  ...
  module Provider
    ...
    abstract def extract_usage(req : HTTP::Request, resp : HTTP::Response) : Trellis::Usage?
    ...
    abstract def decode_stream_event(event : Trellis::SSE::Event) : Array(Trellis::StreamChunk)
  end
end
