...
module Trellis
  # `Trellis.generate_text` — the end-to-end text generation entry point.
  ...
  # `Trellis.stream_text` — the streaming entry point. The front half mirrors
  ...
  # `Trellis.generate_object` — the structured-output entry point. Mirrors
